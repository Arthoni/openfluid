...
BEGIN_BUILDEREXT_SIGNATURE("tests.builderext.modal-spatial.classic", openfluid::builderext::ExtensionMode::MODE_MODAL)

  DECLARE_CATEGORY(openfluid::builderext::ExtensionCategory::CAT_SPATIAL)
