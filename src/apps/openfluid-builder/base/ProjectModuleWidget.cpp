...
void ProjectModuleWidget::whenExtensionAsked(const QString& ID)
{
  ...
  if (ExtReg->isFeatureExtensionRegistered(WareID))
  {
    ...
    {
      if (ExtReg->getExtensionMode(WareID) == openfluid::builderext::ExtensionMode::MODE_MODAL)
      {
      ...
      else if (ExtReg->getExtensionMode(WareID) == openfluid::builderext::ExtensionMode::MODE_MODELESS)
      {
      ...
      else if (ExtReg->getExtensionMode(WareID) == openfluid::builderext::ExtensionMode::MODE_WORKSPACE)
      {
