                      ...
                      bool SslNoVerify)
{
  ...
  return launchCommand(Args, FromUrl, ToPath, Username, Password, SslNoVerify);
}
...
bool GitProxy::advancedClone(const QString& FromUrl, const QString& ToPath, const QString& LocalGitRepoPath,
                      const QString& Username, const QString& Password,
                      bool SslNoVerify, bool WithoutVersioning)
{
  QStringList Args = {"clone", "--recurse-submodules", "--progress"};
