...
BOOST_AUTO_TEST_CASE(check_construction_fromGeovectorValue)
{
  ...
  for (openfluid::landr::LandRGraph::Entities_t::iterator it = Entities.begin();
      it != Entities.end(); ++it)
    Edges.insert((dynamic_cast<openfluid::landr::PolygonEntity*>(*it))->m_PolyEdges.begin(),
...
BOOST_AUTO_TEST_CASE(check_construction_fromEntityVector)
{
  ...
  while ((Feat = Layer0->GetNextFeature()) != nullptr)
  {
    ...
    openfluid::landr::LandREntity* Entity =
      new openfluid::landr::PolygonEntity(dynamic_cast<geos::geom::Polygon*>(GeosGeom->clone().get()),
  ...
  openfluid::landr::PolygonGraph* Graph = openfluid::landr::PolygonGraph::create(Entities);
...
BOOST_AUTO_TEST_CASE(check_construction_onePolygon)
{
  ...
  geos::geom::LinearRing* LR1 = Factory->createLinearRing(SeqFactory.create(Coos1)).get();
...
BOOST_AUTO_TEST_CASE(check_construction_twoSimplePolygons)
{
  ...
  geos::geom::LinearRing* LR2 = Factory->createLinearRing(SeqFactory.create(Coos2)).get();
  geos::geom::Polygon* P2 = Factory->createPolygon(LR2, nullptr);
  openfluid::landr::PolygonEntity Ent2(P2, 2);
  Entites.push_back(&Ent2);

  openfluid::landr::PolygonGraph* Graph = openfluid::landr::PolygonGraph::create(Entites);
...
BOOST_AUTO_TEST_CASE(check_construction_anIsolatedPolygon)
{
  ...
  Coos3->push_back(geos::geom::Coordinate(0, 0));
  geos::geom::LinearRing* LR3 = Factory->createLinearRing(SeqFactory.create(Coos3)).get();
...
BOOST_AUTO_TEST_CASE(check_construction_aFullEnclosedPolygon)
{
  ...
  openfluid::landr::PolygonGraph* TmpGraph = openfluid::landr::PolygonGraph::create(Entites);
  ...
  std::vector<geos::geom::Coordinate>* Coos4 = new std::vector<geos::geom::Coordinate>();
  ...
  geos::geom::LinearRing* LR4 = Factory->createLinearRing(SeqFactory.create(Coos4)).get();
...
{
  openfluid::core::GeoVectorValue* Val =
    new openfluid::core::GeoVectorValue(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "SU_horseshoe_point.shp");
...
BOOST_AUTO_TEST_CASE(check_getOfldIdOrderedEntities)
{
  ...
  int i = 0;
  for (openfluid::landr::LandRGraph::Entities_t::iterator it = OrderedEntities.begin();
       it != OrderedEntities.end(); ++it)
  {
...
BOOST_AUTO_TEST_CASE(check_computeRasterPolyOverlapping_gettingPolygonsOnly)
{
  ...
  BOOST_CHECK_THROW(Graph->computeRasterPolyOverlapping(*U1),openfluid::base::FrameworkException);

  Graph->addAGeoRasterValue(*Raster);

  openfluid::landr::PolygonGraph::RastValByRastPoly_t OverlapsU1 = Graph->computeRasterPolyOverlapping(*U1);

  BOOST_CHECK_EQUAL(OverlapsU1.size(), 12);

  double Area;

  for (openfluid::landr::PolygonGraph::RastValByRastPoly_t::iterator it = OverlapsU1.begin(); it != OverlapsU1.end();
       ++it)
  {
    Area += it->second;
...
BOOST_AUTO_TEST_CASE(check_computeRasterPolyOverlapping_gettingAlsoMultiPolygon)
{
  ...
  openfluid::landr::PolygonGraph::RastValByRastPoly_t OverlapsU2 = Graph->computeRasterPolyOverlapping(*U2);

  BOOST_CHECK_EQUAL(OverlapsU2.size(), 20);

  double Area = 0;

  for (openfluid::landr::PolygonGraph::RastValByRastPoly_t::iterator it = OverlapsU2.begin();
       it != OverlapsU2.end(); ++it)
  {
    Area += it->second;
...
BOOST_AUTO_TEST_CASE(check_createVectorRepresentation)
{
  ...
  Graph->createVectorRepresentation(CONFIGTESTS_OUTPUT_DATA_DIR + "/landr","SUGraph.shp");

  openfluid::core::GeoVectorValue GraphVal(CONFIGTESTS_OUTPUT_DATA_DIR + "/landr", "SUGraph.shp");

  openfluid::landr::VectorDataset* GraphVect = new openfluid::landr::VectorDataset(GraphVal);
...
BOOST_AUTO_TEST_CASE(check_computeLineStringNeighboursOfPolygonGraph_Contains)
{
  ...
  SUGraph->computeLineStringNeighbours(*RSGraph,openfluid::landr::LandRTools::CONTAINS,0);
  ...
  SUGraph->computeLineStringNeighbours(*RSGraph,openfluid::landr::LandRTools::CONTAINS,0.0001);
...
BOOST_AUTO_TEST_CASE(check_computeLineStringNeighboursOfPolygonGraph_Intersect)
{
  ...
  SUGraph->computeLineStringNeighbours(*RSGraph,openfluid::landr::LandRTools::INTERSECTS,0);
  ...
  SUGraph->computeLineStringNeighbours(*RSGraph,openfluid::landr::LandRTools::INTERSECTS,0.0001);
...
BOOST_AUTO_TEST_CASE(check_polygon_has_islands)
{
  ...
  openfluid::core::GeoVectorValue* PolHole =
    new openfluid::core::GeoVectorValue(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "SU-has-hole.shp");

  openfluid::landr::PolygonGraph* GraphHole = openfluid::landr::PolygonGraph::create(*PolHole);

  openfluid::core::GeoVectorValue* PolIsland =
    new openfluid::core::GeoVectorValue(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "SU-has-islands.shp");

  openfluid::landr::PolygonGraph* GraphIsland = openfluid::landr::PolygonGraph::create(*PolIsland);
...
BOOST_AUTO_TEST_CASE(check_getPolygonEntityByMinArea)
{
  ...
  BOOST_CHECK_THROW(Graph->getPolygonEntitiesByMinArea(-1),openfluid::base::FrameworkException);
  BOOST_CHECK_THROW(Graph->getPolygonEntitiesByMinArea(0),openfluid::base::FrameworkException);
  ...
  Vector = new openfluid::core::GeoVectorValue(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "SU_To_Snap.shp");

  Graph = openfluid::landr::PolygonGraph::create(*Vector);
...
{
  openfluid::core::GeoVectorValue* Val =
    new openfluid::core::GeoVectorValue(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "BAD_POLYTEST.shp");

  BOOST_CHECK_THROW(openfluid::landr::PolygonGraph::create(*Val),openfluid::base::FrameworkException);

  delete Val;

  openfluid::core::GeoVectorValue Val2(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr","BAD_POLYTEST.shp");

  openfluid::landr::VectorDataset* Vect = new openfluid::landr::VectorDataset(Val2);

  BOOST_CHECK_THROW(openfluid::landr::PolygonGraph::create(*Vect),openfluid::base::FrameworkException);
...
BOOST_AUTO_TEST_CASE(check_computeLineStringNeighboursOfPolygonGraph_Contains_with_Complex_LineString)
{
  ...
  SUGraph->computeLineStringNeighbours(*RSGraph,openfluid::landr::LandRTools::CONTAINS,5);
...
BOOST_AUTO_TEST_CASE(check_computeLineStringNeighboursOfPolygonGraph_Intersects_with_Complex_LineString)
{
  ...
  SUGraph->computeLineStringNeighbours(*RSGraph,openfluid::landr::LandRTools::INTERSECTS,5);
  BOOST_CHECK_EQUAL(SU10->lineStringNeighbours()->size(), 0);
...
BOOST_AUTO_TEST_CASE(check_computeLineStringNeighboursOfPolygonGraph_Touches_with_Complex_LineString)
{
  ...
  BOOST_CHECK_THROW(SUGraph->computeLineStringNeighbours(*RSGraph,openfluid::landr::LandRTools::TOUCHES,0),
                    openfluid::base::FrameworkException);
  ...
  SUGraph->computeLineStringNeighbours(*RSGraph,openfluid::landr::LandRTools::TOUCHES,5,50);
...
{
  openfluid::core::GeoVectorValue* Val =
    new openfluid::core::GeoVectorValue(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "MultiPolygon.shp");
...
{
  openfluid::core::GeoVectorValue* Vector =
    new openfluid::core::GeoVectorValue(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "SU_dem_Nodata.shp");

  openfluid::core::GeoRasterValue* Raster =
    new openfluid::core::GeoRasterValue(CONFIGTESTS_INPUT_MISCDATA_DIR + "/GeoRasterValue", "dem2.Gtiff");
...
BOOST_AUTO_TEST_CASE(check_computeNeighboursWithBarriers)
{
  ...
  BOOST_CHECK_THROW(
    SUGraph->computeNeighboursWithBarriers(*BarriersGraph,openfluid::landr::LandRTools::INTERSECTS,0.01),
    openfluid::base::FrameworkException);

  SUGraph->computeNeighboursWithBarriers(*BarriersGraph,openfluid::landr::LandRTools::CONTAINS,0.01);
  ...
  SUGraph->computeNeighboursWithBarriers(*BarriersGraph,openfluid::landr::LandRTools::TOUCHES,0.01,0.2);
  ...
  SUGraph->computeNeighboursWithBarriers(*BarriersGraph,openfluid::landr::LandRTools::TOUCHES,0.1,0.2);
  ...
  SUGraph->computeLineStringNeighbours(*RSGraph,openfluid::landr::LandRTools::INTERSECTS,0.01);
...
{
  openfluid::core::GeoVectorValue* ValPoly =
    new openfluid::core::GeoVectorValue(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "SU.shp");

  openfluid::landr::PolygonGraph* PolyGraph = openfluid::landr::PolygonGraph::create(*ValPoly);
...
{
  openfluid::core::GeoVectorValue* Val =
    new openfluid::core::GeoVectorValue(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "BAD_POLYGEOM.shp");
...
BOOST_AUTO_TEST_CASE(check_construction_from_non_PolygonType)
{
  ...
  openfluid::core::GeoVectorValue Val2(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr","RS.shp");

  openfluid::landr::VectorDataset* Vect = new openfluid::landr::VectorDataset(Val2);

  openfluid::landr::PolygonGraph* Graph2=nullptr;
  BOOST_CHECK_THROW(Graph2 = openfluid::landr::PolygonGraph::create(*Vect),openfluid::base::FrameworkException);
