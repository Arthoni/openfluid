...
BOOST_AUTO_TEST_CASE(check_construction)
{
  ...
  BOOST_CHECK_EQUAL(Val.getType(),openfluid::core::UnstructuredValue::UnstructuredType::GeoVectorValue);
...
BOOST_AUTO_TEST_CASE(check_nodes)
{
  ...
  BOOST_CHECK(U1->startNode()->getCoordinate().equals(U2->endNode()->getCoordinate()));
  BOOST_CHECK(U2->startNode()->getCoordinate().equals(U3->endNode()->getCoordinate()));
  BOOST_CHECK(U2->startNode()->getCoordinate().equals(U8->endNode()->getCoordinate()));
  BOOST_CHECK(U2->startNode()->getCoordinate().equals(U7->endNode()->getCoordinate()));
...
BOOST_AUTO_TEST_CASE(check_LineOrientNeighbours)
{
  ...
  std::vector<openfluid::landr::LineStringEntity*> U1Down = U1->getLineOrientDownNeighbours();
  std::vector<openfluid::landr::LineStringEntity*> U2Down = U2->getLineOrientDownNeighbours();
  std::vector<openfluid::landr::LineStringEntity*> U3Down = U3->getLineOrientDownNeighbours();
  std::vector<openfluid::landr::LineStringEntity*> U8Down = U8->getLineOrientDownNeighbours();
  std::vector<openfluid::landr::LineStringEntity*> U4Down = U4->getLineOrientDownNeighbours();
...
BOOST_AUTO_TEST_CASE(check_Neighbours)
{
  ...
  BOOST_CHECK_EQUAL(*Graph->entity(1)->neighbours()->begin(), Graph->entity(2));
  ...
  BOOST_CHECK_EQUAL(*Graph->entity(5)->neighbours()->begin(), Graph->entity(4));
