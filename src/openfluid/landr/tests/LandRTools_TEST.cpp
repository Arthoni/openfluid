...
BOOST_AUTO_TEST_CASE(check_computeVectorOfExteriorRings)
{
  ...
  BOOST_CHECK_THROW(openfluid::landr::LandRTools::computeVectorOfExteriorRings(*Vect),
                    openfluid::base::FrameworkException);

  delete Vect;

  Val = openfluid::core::GeoVectorValue(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "SU.shp");

  Vect = new openfluid::landr::VectorDataset(Val);

  std::vector<geos::geom::LineString*> Geoms = openfluid::landr::LandRTools::computeVectorOfExteriorRings(*Vect);
...
BOOST_AUTO_TEST_CASE(check_computeVectorOfLines)
{
  ...
  BOOST_CHECK_THROW(openfluid::landr::LandRTools::computeVectorOfLines(*Vect),openfluid::base::FrameworkException);

  delete Vect;

  Val = openfluid::core::GeoVectorValue(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "RS.shp");

  Vect = new openfluid::landr::VectorDataset(Val);

  std::vector<geos::geom::LineString*> Geoms = openfluid::landr::LandRTools::computeVectorOfLines(*Vect);
...
{
  openfluid::core::GeoVectorValue ValSU(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "POLY_TEST.shp");

  openfluid::core::GeoVectorValue ValRS(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "LINE_TEST.shp");

  openfluid::landr::VectorDataset* VectSU = new openfluid::landr::VectorDataset(ValSU);

  openfluid::landr::VectorDataset* VectRS = new openfluid::landr::VectorDataset(ValRS);

  std::vector<geos::geom::LineString*> SU_lines = openfluid::landr::LandRTools::computeVectorOfExteriorRings(*VectSU);

  std::vector<geos::geom::LineString*> RS_lines = openfluid::landr::LandRTools::computeVectorOfLines(*VectRS);
...
{
  openfluid::core::GeoVectorValue ValSU(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "POLY_TEST.shp");
  openfluid::core::GeoVectorValue ValSU2(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "POLY_TEST2.shp");
  openfluid::core::GeoVectorValue ValRS(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "LINE_TEST.shp");
  openfluid::core::GeoVectorValue ValRS2(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "LINE_TEST2.shp");

  openfluid::landr::VectorDataset* VectSU = new openfluid::landr::VectorDataset(ValSU);

  openfluid::landr::VectorDataset* VectSU2 =new openfluid::landr::VectorDataset(ValSU2);

  openfluid::landr::VectorDataset* VectRS = new openfluid::landr::VectorDataset(ValRS);

  openfluid::landr::VectorDataset* VectRS2 = new openfluid::landr::VectorDataset(ValRS2);

  std::vector<geos::geom::LineString*> SU_lines = openfluid::landr::LandRTools::computeVectorOfExteriorRings(*VectSU);
  std::vector<geos::geom::LineString*> SU2_lines = openfluid::landr::LandRTools::computeVectorOfExteriorRings(*VectSU2);
  std::vector<geos::geom::LineString*> RS_lines = openfluid::landr::LandRTools::computeVectorOfLines(*VectRS);
  std::vector<geos::geom::LineString*> RS2_lines = openfluid::landr::LandRTools::computeVectorOfLines(*VectRS2);
  ...
  BOOST_CHECK_THROW(openfluid::landr::LandRTools::computeNodedLines(SU_coll, RS_coll),
                   openfluid::base::FrameworkException);
#endif
...
{
  openfluid::core::GeoVectorValue ValSU(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "field.shp");
  openfluid::core::GeoVectorValue ValSU2(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "soil.shp");
...
//  for (unsigned int i = 0; i < Noded_lines->size(); i++)
 //   std::cout << Noded_lines->at(i)->toString() << std::endl;
  ...
  openfluid::landr::LandRTools::polygonizeGeometry(Noded, ThePolygons, TheDangles);
...
{
  openfluid::core::GeoVectorValue Val(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "field.shp");
  openfluid::core::GeoVectorValue Val2(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "soil.shp");
  openfluid::core::GeoVectorValue Val3(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "reach.shp");

  openfluid::landr::VectorDataset* Vect = new openfluid::landr::VectorDataset(Val);
  openfluid::landr::VectorDataset* Vect2 = new openfluid::landr::VectorDataset(Val2);
  openfluid::landr::VectorDataset* Vect3 = new openfluid::landr::VectorDataset(Val3);

  std::vector<geos::geom::LineString*> Field_lines = openfluid::landr::LandRTools::computeVectorOfExteriorRings(*Vect);
  std::vector<geos::geom::LineString*> Soil_lines = openfluid::landr::LandRTools::computeVectorOfExteriorRings(*Vect2);
  ...
  All_lines->clear();
  All_lines = openfluid::landr::LandRTools::computeNodedLines(Poly_coll, Vect3->geometries(), 0.00001);
...
{
  openfluid::core::GeoVectorValue Val(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr/virtual", "field2.shp");
  openfluid::core::GeoVectorValue Val2(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr/virtual", "soil.shp");
  openfluid::core::GeoVectorValue Val3(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr/virtual", "reach5.shp");
  ...
  std::vector<geos::geom::LineString*>* NodedPolys =
      openfluid::landr::LandRTools::computeNodedLines(Field_coll, Soil_coll,snapTolerance);
 ...
 //     std::cout << NodedPolys->at(i)->toString() << std::endl;
  ...
  openfluid::landr::LandRTools::polygonizeGeometry(All, ThePolygons, TheDangles);
...
BOOST_AUTO_TEST_CASE(check_computeNodedLines_virtual_snap)
{
  ...
  NodedPolys->clear();
  NodedPolys = openfluid::landr::LandRTools::computeNodedLines(Field_coll,Soil_coll,snapTolerance);
...
{
  openfluid::core::GeoVectorValue Val(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "POLY_TEST.shp");
  openfluid::core::GeoVectorValue ValLine(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "LINE_TEST.shp");
  ...
  BOOST_CHECK_THROW(openfluid::landr::LandRTools::computeIntersectPolygons(GeomLine, Geom1),
                    openfluid::base::FrameworkException);

  BOOST_CHECK_THROW(openfluid::landr::LandRTools::computeIntersectPolygons(Geom1, GeomLine),
                    openfluid::base::FrameworkException);

  delete VectLine;

  openfluid::core::GeoVectorValue Val2(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "POLY_TEST2.shp");
...
BOOST_AUTO_TEST_CASE(check_splitLineStringByPoint)
{
  ...
  BOOST_CHECK_THROW(openfluid::landr::LandRTools::splitLineStringByPoint(
                      *const_cast<geos::geom::LineString*>(Graph->entity(7)->line()),*Point,0),
                    openfluid::base::FrameworkException);
...
BOOST_AUTO_TEST_CASE(check_splitLineStringByPoints)
{
  ...
  BOOST_CHECK_THROW(openfluid::landr::LandRTools::splitLineStringByPoints(
                      *const_cast<geos::geom::LineString*>(Graph->entity(7)->line()),vPoints,0,vEntities),
                    openfluid::base::FrameworkException);
...
BOOST_AUTO_TEST_CASE(check_intersect_horseshoe_with_polygon)
{
  ...
  openfluid::core::GeoVectorValue Val(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "POLY_TEST.shp");
  openfluid::core::GeoVectorValue ValHorse(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "POLY_HORSESHOE.shp");
  ...
  openfluid::core::GeoVectorValue ValHole(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "SU-has-hole.shp");
  ...
  IntersectPolys.clear();
  openfluid::core::GeoVectorValue ValIsland(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "SU-has-islands.shp");
...
BOOST_AUTO_TEST_CASE(check_cleanLines_after_Intersect2Polys)
{
  ...
  openfluid::core::GeoVectorValue ValSU(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "fields_extract2.shp");
  openfluid::core::GeoVectorValue ValSU2(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "soils_extract3.shp");
...
{
  openfluid::core::GeoRasterValue RasterVal(CONFIGTESTS_INPUT_MISCDATA_DIR + "/GeoRasterValue", "dem.jpeg");

  openfluid::landr::RasterDataset* Rast = new openfluid::landr::RasterDataset(RasterVal);
  ...
  openfluid::core::GeoVectorValue Value2(CONFIGTESTS_INPUT_MISCDATA_DIR + "/landr", "POLY_TEST.shp");
