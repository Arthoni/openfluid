...
#define OPENFLUID_LogWarning(_stream) \
  appendToLog(openfluid::tools::FileLogger::LogType::LOG_WARNING,_STREAMTOSTRING(_stream))
...
#define OPENFLUID_DisplayWarning(_stream) \
  displayToConsole(openfluid::tools::FileLogger::LogType::LOG_WARNING,_STREAMTOSTRING(_stream))
...
#define OPENFLUID_LogInfo(_stream) \
  appendToLog(openfluid::tools::FileLogger::LogType::LOG_INFO,_STREAMTOSTRING(_stream))
...
#define OPENFLUID_DisplayInfo(_stream) \
  displayToConsole(openfluid::tools::FileLogger::LogType::LOG_INFO,_STREAMTOSTRING(_stream))
...
#define OPENFLUID_LogDebug(_stream) \
  appendToLog(openfluid::tools::FileLogger::LogType::LOG_DEBUG,_STREAMTOSTRING(_stream))

#define OPENFLUID_DisplayDebug(_stream) \
  displayToConsole(openfluid::tools::FileLogger::LogType::LOG_DEBUG,_STREAMTOSTRING(_stream))
