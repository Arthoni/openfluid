...
BOOST_AUTO_TEST_CASE(check_addItem_regular)
{
  ...
  BOOST_CHECK_EQUAL(static_cast<int>(Item->value()->getType()), 
                    static_cast<int>(openfluid::core::UnstructuredValue::UnstructuredType::GeoVectorValue));
  ...
  BOOST_REQUIRE(Item->value() != 0);
  BOOST_CHECK_EQUAL(static_cast<int>(Item->value()->getType()), 
                    static_cast<int>(openfluid::core::UnstructuredValue::UnstructuredType::GeoRasterValue));
