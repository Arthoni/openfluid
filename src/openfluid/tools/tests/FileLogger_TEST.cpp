...
BOOST_AUTO_TEST_CASE(check_operations_1)
{
  ...
  Log.add(openfluid::tools::FileLogger::LogType::LOG_INFO,"test","info 1");
  Log.add(openfluid::tools::FileLogger::LogType::LOG_DEBUG,"test","debug 1");
  Log.add(openfluid::tools::FileLogger::LogType::LOG_INFO,"test","info 2");
  Log.add(openfluid::tools::FileLogger::LogType::LOG_WARNING,"test","warning 1");
  Log.add(openfluid::tools::FileLogger::LogType::LOG_ERROR,"test","error");
...
BOOST_AUTO_TEST_CASE(check_operations_2)
{
  ...
  Log.add(openfluid::tools::FileLogger::LogType::LOG_DEBUG,"test","debug 1");
  Log.add(openfluid::tools::FileLogger::LogType::LOG_INFO,"test","info 2");
  Log.add(openfluid::tools::FileLogger::LogType::LOG_WARNING,"test","warning");
  Log.add(openfluid::tools::FileLogger::LogType::LOG_WARNING,"test","warning");
  Log.add(openfluid::tools::FileLogger::LogType::LOG_WARNING,"test","warning");
  Log.add(openfluid::tools::FileLogger::LogType::LOG_WARNING,"test","warning");
  Log.add(openfluid::tools::FileLogger::LogType::LOG_WARNING,"test","warning");
