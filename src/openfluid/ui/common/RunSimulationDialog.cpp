  ...
  m_Launched(false), m_Success(true), m_CanClose(true)
{
  ...
  setStage(openfluid::ui::common::RunSimulationListener::Stage::RUNW_BEFORE);
...
{
  if (S == openfluid::ui::common::RunSimulationListener::Stage::RUNW_BEFORE)
  {
    ui->StatusLabel->setStatus(ExecutionStatusLabel::Status::NOTSTARTED);
    ui->StageLabel->setText("-");
  }
  else if (S == openfluid::ui::common::RunSimulationListener::Stage::RUNW_PRESIM)
  {
    ui->StageLabel->setText(tr("pre-simulation"));
    ui->StatusLabel->setStatus(ExecutionStatusLabel::Status::RUNNING);
  }
  else if (S == openfluid::ui::common::RunSimulationListener::Stage::RUNW_INIT)
  {
    ui->StageLabel->setText(tr("initialization"));
    ui->StatusLabel->setStatus(ExecutionStatusLabel::Status::RUNNING);
  }
  else if (S == openfluid::ui::common::RunSimulationListener::Stage::RUNW_RUN)
  {
    ui->StageLabel->setText(tr("simulation"));
    ui->StatusLabel->setStatus(ExecutionStatusLabel::Status::RUNNING);
  }
  else if (S == openfluid::ui::common::RunSimulationListener::Stage::RUNW_FINAL)
  {
    ui->StageLabel->setText(tr("finalization"));
    ui->StatusLabel->setStatus(ExecutionStatusLabel::Status::RUNNING);
  }
  else if (S == openfluid::ui::common::RunSimulationListener::Stage::RUNW_AFTER)
  {
    ui->StageLabel->setText("-");
...
void RunSimulationDialog::setCompleted()
{
  ...
  ui->ElapsedLabel->setText(QString::fromStdString(m_ElapsedTimer.elapsedAsPrettyString()));
}
