...
WaresSrcImportDialog::WaresSrcImportDialog(QWidget* Parent) :
    GenericSrcImportDialog(Parent), ui(new Ui::WaresSrcImportDialog)
{
  ui->setupUi(this);
...
void WaresSrcImportDialog::onHubConnectButtonClicked()
{
  ...
  GenericSrcImportDialog::onHubConnectButtonClicked();
}
...
void WaresSrcImportDialog::onImportAsked()
{
  ...
  else
  {
    ...
    importThreadWrapper(Thread, mp_FluidHubWaresImportWorker, &ProgressDialog);
  }
