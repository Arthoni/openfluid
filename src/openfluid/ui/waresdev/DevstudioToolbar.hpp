...
#ifndef __OPENFLUID_UIWARESDEV_DEVSTUDIOTOOLBAR_HPP__
#define __OPENFLUID_UIWARESDEV_DEVSTUDIOTOOLBAR_HPP__
...
class OPENFLUID_API DevstudioToolbar: public QToolBar
{
  Q_OBJECT
  ...
  public:
    ...
    DevstudioToolbar(bool IsIncluded, QWidget* Parent = nullptr);

    virtual ~DevstudioToolbar();
...
#endif /* __OPENFLUID_UIWARESDEV_DEVSTUDIOTOOLBAR_HPP__ */
