...
BOOST_AUTO_TEST_CASE(create_files_bext)
{
  ...
  R.BuilderExtCategoryIndex = 0;  //"openfluid::builderext::ExtensionCategory::CAT_SPATIAL"
  ...
  R.BuilderExtModeIndex = 0;  //openfluid::builderext::ExtensionType::TYPE_MODAL
  ...
  BOOST_CHECK(CppFileContent.contains("BEGIN_BUILDEREXT_SIGNATURE(\"bext.id\", "
                                      "openfluid::builderext::ExtensionMode::MODE_MODAL)"));
  BOOST_CHECK(CppFileContent.contains("DECLARE_CATEGORY(openfluid::builderext::ExtensionCategory::CAT_SPATIAL)"));
  ...
  R.BuilderExtModeIndex = 1;  //openfluid::builderext::ExtensionType::TYPE_MODELESS
  ...
  R.BuilderExtModeIndex = 2;  //openfluid::builderext::ExtensionType::TYPE_WORKSPACE
