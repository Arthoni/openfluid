...
FUNCTION(EXECUTE_COMMAND CMD)
  ...
  ELSEIF(${CMD} STREQUAL "CHECK_FILE_CONTAINS")
    ...
    STRING(FIND "${FILE_CONTENT}" "${ARGV2}" ISMATCH)
    IF(${ISMATCH} EQUAL -1)
      MESSAGE(FATAL_ERROR "CHECK_FILE_CONTAINS: file ${ARGV1} does not contain string ${ARGV2}")
    ENDIF()

  ELSEIF(${CMD} STREQUAL "CHECK_FILE_NOT_CONTAINS")
    FILE(READ ${ARGV1} FILE_CONTENT)
    STRING(FIND "${FILE_CONTENT}" "${ARGV2}" ISMATCH)
    IF(NOT ${ISMATCH} EQUAL -1)
      MESSAGE(FATAL_ERROR "CHECK_FILE_NOT_CONTAINS: file ${ARGV1} does contain string ${ARGV2}")
    ENDIF()
  ...
  FOREACH(ELEM ${ARGN})
    ...
    IF(${CMD_EXPECTED})
      IF(${ELEM} STREQUAL "CHECK_FILE_EXIST" OR
         ...
         ${ELEM} STREQUAL "CHECK_FILE_NOT_CONTAINS" OR
    ...
    ELSE()
      IF(${CURRENT_CMD} STREQUAL "COMPARE_FILES" OR
         ...
         ${CURRENT_CMD} STREQUAL "CHECK_FILE_NOT_CONTAINS" OR
