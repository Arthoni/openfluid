...
FUNCTION(OFBUILD_ADD_WARE)
  ...
  SET(_ARGS_OPTIONS "WITH_DOCALYZE")
  ...
  MESSAGE(WARNING "OFPATH: ${OFBUILD_DIST_DIR}/openfluid")  # HACK remove when mismatch diagnosis done
  ...
  ADD_CUSTOM_COMMAND(
    ...
    COMMAND "${CMAKE_COMMAND}" 
       ARGS "-DWARE_SOURCE_DIR=${CMAKE_CURRENT_SOURCE_DIR}/${_BUILDARGS_DIRID}" "-DWARE_BUILD_DIR=${CMAKE_CURRENT_BINARY_DIR}/${_BUILDARGS_DIRID}"
            ...
            "-DWARE_WITH_DOCALYZE=${_BUILDARGS_WITH_DOCALYZE}"
            "-DOFBUILD_DIST_DIR=${OFBUILD_DIST_DIR}"
...
FUNCTION(OFBUILD_ADD_SIMULATOR DIRID)
  ...
  OFBUILD_ADD_WARE(DIRID "${DIRID}" TYPE "simulator" 
                   TARGET_PREFIX "simulator" 
                   PREFIX_INSTALL_PATH "${OFBUILD_DIST_DIR}/${OPENFLUID_WARES_INSTALL_PATH}"
                   WITH_DOCALYZE)
...
FUNCTION(OFBUILD_ADD_TEST_SIMULATOR DIRID)
  ...
  OFBUILD_ADD_WARE(DIRID "${DIRID}" TYPE "simulator" 
                   TARGET_PREFIX "test-simulator" 
                   INSTALL_PATH "${OFBUILD_TESTS_BINARY_DIR}")
...
FUNCTION(OFBUILD_ADD_EXAMPLE_SIMULATOR DIRID)
  ...
  OFBUILD_ADD_WARE(DIRID "${DIRID}" TYPE "simulator" 
                   TARGET_PREFIX "example-simulator" 
                   PREFIX_INSTALL_PATH "${OFBUILD_DIST_DIR}/${OPENFLUID_WARES_INSTALL_PATH}"
                   WITH_DOCALYZE)
